<template>
  <section id="made">
    <div class="container">
      <div class="title-box">
        <h2>
          <span> инновационные решения <br /></span> и современные технологии
        </h2>
        <p class="subtitle">
        ...
        <div id="made-wrapper__modal" class="made-wrapper__modal">
          <div class="made-modal">
            ...
            <div class="made-modal__content">
              ...
              <p>
                Мы работаем с 2012 года, и производим лишь качественные товары,
              ...
              <p>
                В автоклаве «Крестьянка» наши конструктора соединили два вида
                нержавеющей стали: AISI 304 и 430. Это позволяет использовать
                плиты любого типа, сохраняя высокую износоустойчивость.
                «Крестьянка» — современный автоклав, обеспечивающий высокое
                качество, скорость и безопасность создания заготовок. Вы можете
                выбирать источник нагрева (ТЭН или плита) и режим работы (на
                пару или на воде).
              </p>
            </div>
          </div>
    ...
    &__content {
      ...
      p {
        ...
        @media (max-width: 1500px) and (min-width: 1281px) {
          @include fluidFontSize(16, 18, 1281, 1440);
        }
