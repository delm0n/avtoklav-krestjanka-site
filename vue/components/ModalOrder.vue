    ...
    <div class="modal-order__box">
      <div class="modal-order__img">
        <div class="modal-order__img-logo">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_135_10159)">
              <path
              ...
              <path
                d="M40.2491 60.0057C40.2491 60.0057 39.6622 57.4749 39.7232 55.6369C39.7631 54.4325 40.2396 52.1387 40.2396 52.1387L40.9193 54.8147C40.9193 54.8147 40.6592 55.4261 40.5324 55.8324C40.0474 57.3881 40.2491 60.0057 40.2491 60.0057Z"
                fill="#047DD9"
              />
              <path
                d="M52.5501 1.13867C53.688 9.82819 52.1363 16.1385 51.582 18.897C51.8733 20.1849 52.9012 20.0447 53.1911 13.1262C53.4809 6.20759 52.9953 3.68754 52.5501 1.13867Z"
                fill="#047DD9"
              />
              <path
                d="M55.7062 11.1836C54.9123 18.4086 54.4251 19.2623 53.8203 21.7801C54.0049 22.7817 54.2486 22.2444 54.7904 19.5968C55.616 15.5652 55.5907 13.375 55.7062 11.1836Z"
                fill="#047DD9"
              />
              <path
      ...
      <div class="modal-order__content">
        ...
        <ul class="content-dopslist">
          <li v-for="(dop, index) in getDops" :key="index">
